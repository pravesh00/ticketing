...
class EventViewModel(
    ...
    fun prePopulateEventData(){
        ...
        lst.add(Event("A1","Wonder Women","Set in the 1980s, Wonder Woman`s next big screen adventure finds her facing two all-new foes, Max Lord and The Cheetah, and the unexpected return of a face from her past.","Movie","https://i.imgur.com/CxvVAcK.jpg","",""))
        ...
        lst.add(Event("C1","Chaos Walking","In the not too distant future, Todd Hewitt discovers Viola, a mysterious girl who crash lands on his planet, where all the women have disappeared and the men are afflicted by \\\"the Noise\\\" - a force that puts all their thoughts on display. In this dangerous landscape, Viola`s life is threatened - and as Todd vows to protect her, he will have to discover his own inner power and unlock the planet`s dark secrets.","Movie","https://i.imgur.com/hEVn8dT.jpg","",""))
        ...
        lst.add(Event("E1","Whats calling ur name?","In the not too distant future, Todd Hewitt discovers Viola, a mysterious girl who crash lands on his planet, where all the women have disappeared and the men are afflicted by \\\"the Noise\\\" - a force that puts all their thoughts on display. In this dangerous landscape, Viola`s life is threatened - and as Todd vows to protect her, he will have to discover his own inner power and unlock the planet`s dark secrets.","Play","https://i.imgur.com/hEVn8dT.jpg","",""))
